...
from ThirdParty.muggle_ocr.init_data import init_img
...
class SDK(object):
    ...
    def __init__(self, model_type: ModelType = ModelType.OCR, conf_path=None):
        """
...
if __name__ == '__main__':
    # FROM PATH
    sdk = SDK(conf_path=r"./muggle_ocr/captcha.yaml")
